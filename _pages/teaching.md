...
The course finally gives an overview of how cloud microphysics is represented in numerical models, including bulk, bin, and Lagrangian schemes, with discussion of their assumptions, advantages, and limitations.
  ...
  <em><font color="Grey">A closer look into cloud microphysics, highlighting stunning diversity and complexity of ice crystals. Photographs by my doctoral advisor,</font> [Prof. Dr. Bernhard Mayer (Meteorological Institute, LMU Munich),](https://www.en.meteo.physik.uni-muenchen.de/forschung/atmo_fern/index.html) <font color="Grey">an exceptional cloud-radiation scientist and photographer.</font></em><br/>
