...
* **Assistant Professor**, University of Ljubljana, Slovenia (2024 – present)<br/>
  * <ins>Subject</ins>: [**Dynamical Meteorology II**](https://www.fmf.uni-lj.si/en/study-physics/programmes/2fiz/2025/7000780/courses/751/) (MSc level)
    * <ins>Content</ins>: This subject covers a wide range of topics, including convection and thunderstorms (single cells, multicells, supercells), tornadoes, mesoscale instabilities, mesoscale wave motions, planetary boundary layer processes and turbulence, frontal dynamics, and the fundamentals of general circulation. The course is currently being developed; a detailed syllabus will be available soon.
  * <ins>Subject</ins>: [**Physical Meteorology — Cloud Microphysics**](https://www.fmf.uni-lj.si/en/study-physics/programmes/2fiz/2025/7000786/courses/600/) (MSc level)
    * <ins>Content</ins>: This subject covers fundamental microphysical phenomena and processes governing the formation and evolution of clouds and precipitation. It first introduces observed microphysical properties of various hydrometeors (cloud droplets, raindrops, ice crystals, snowflakes, graupel, hail), including their shapes, characteristic sizes, and size distributions; and explains how useful quantities such as number concentration, liquid water content, and precipitation rate are derived from particle spectra. A wide variety of observed ice crystal habits and the Nakaya morphology diagram are discussed.
The molecular structure of water in its vapor, liquid, and ice phases is further examined, along with common defects in natural ice. Atmospheric aerosols are addressed in terms of their classification, sources and sinks, spatial variability, as well as their role as cloud condensation nuclei (CCN) and ice nuclei (IN).
Thermodynamic foundations comprise the Clausius–Clapeyron equation, supersaturation, supercooled water, and differences in saturation vapor pressure over (supercooled) liquid water and ice. The curvature (Kelvin) and solute (Raoult) effects on saturation vapor pressure are explained, and hence the generalized Köhler framework is established. 
Hydrometeor formation and growth processes are treated in detail. Liquid-phase processes include cloud droplet nucleation, condensational growth, sedimentation and growth by collision and coalescence. Ice- and mixed-phase processes encompass ice nucleation (involving various types of heterogeneous ice nucleation), depositional growth, aggregation, riming and accretion, hail growth in both dry and wet regimes, and the Wegener–Bergeron–Findeisen mechanism.
The course finally gives an overview of how cloud microphysics is represented in numerical models, including bulk, bin, and Lagrangian schemes, with discussion of their assumptions, advantages, and limitations.

  ![Microphysics](/photos/Microphysics_BMayer.png)<br/>
      
  <em><font color="Grey">A closer look into cloud microphysics, highlighting stunning diversity and complexity of ice crystals. Photographs by my doctoral advisor,</font> [Prof. Dr. Bernhard Mayer (Meteorological Institute, LMU Munich),](https://www.en.meteo.physik.uni-muenchen.de/forschung/atmo_fern/index.html) <font color="Grey">an exceptional cloud-radiation scientist and photographer. View more of his amazing photography on</font> [Instagram](https://www.instagram.com/bernhard_mayer_66/)</em><br/>

  * <ins>Subject</ins>: [**Atmospheric Numerical Modelling**](https://www.fmf.uni-lj.si/en/study-physics/programmes/2fiz/2024/7000785/courses/669/) (MSc level)
    * <ins>Content</ins>: Introduction to models and model errors. Examples of atmospheric numerical models (AGCM, NWP, CRM, LES, DNS). Prognostic and diagnostic variables / equations. Partial differential equations (PDEs) in meteorology. Advection equation. Navier-Stokes equations. Primary and secondary circulation of tropical cyclones, tornado structure and dynamics, and corresponding PDEs. Method of characteristics. Finite difference methods to approximate derivatives (forward, backward and central difference approximations) including derivation and accuracy analysis. Finite-difference approximations of first, second and mixed derivatives as well as Laplacian operator are examined in detail. Numerical schemes: upstream / upwind scheme for advection (working example), truncation error and consistency condition, discretization error and convergence condition, Courant-Friedrichs-Lewy (CFL) criterion. Testing stability of numerical schemes using direct, energy and von Neumman methodologies. Grids: regular (lat-lon), triangular and hexagonal grids, structured and unstructured grids, unstaggered and staggered grids (Arakawa), nesting, variable-resolution modelling. Vertical discretization, various choices for vertical coordinates such as height, pressure, sigma (terrain-following coordinate), hybrid pressure-sigma, etc. Methods for time integration: general formulation for a family of multi-level, noniterative, explicit and implicit time schemes. Overview of explicit (e.g., Euler, Adams-Bashfort, Leapfrog) and implicit (e.g., trapezoidal, Adams-Moulton) time schemes including accuracy analysis. Noniterative versus iterative ("predictor-corrector") schemes (e.g., Runge-Kutta). Spectral methods. Radiative transfer theory and modelling. Air pollution theory and modelling. The seminar part of this subject demonstrates numerical modelling of tropical cyclones using the NCAR Cloud Model (CM1). Other state-of-the-art atmospheric numerical modelling examples from worldwide communities (e.g., Waves To Weather, DYAMOND/++, CMIP6) are shown in class.
  ...
  * <ins>Subject</ins>: [**Meteorological Observations and Instruments**](https://www.fmf.uni-lj.si/en/study-physics/programmes/1fiz/2024/7002912/courses/1274/) (BSc level)
  ...
  * <ins>Subject</ins>: **Meteorology** (BSc level)
  ...
  * <ins>Subject</ins>: **Air & Air Pollution** — meteorological part (BSc level)
  ...
  * <ins>Lecture</ins>: **Clouds, Climate Modelling and Climate Change: How cloudy will our future be?** within subject **[Selected Topics in Contemporary Physics](https://www.fmf.uni-lj.si/en/study-mathematics/programmes/3mafi/2024/7003223/courses/576/)** (PhD level)
  ...
  * <ins>Lecture</ins>: **Global Climate Modelling** within subject **[Climate Change](https://podnebnespremembe.fmf.uni-lj.si/)** (BSc level)
    * <ins>Content</ins>: As outlined below on this page.<br/>

* **Invited lecturer**, University of Ljubljana, Slovenia (2024)<br/>
  * <ins>Lecture</ins>: **Global Climate Modeling** within interdisciplinary subject **[Climate Change](https://podnebnespremembe.fmf.uni-lj.si/)** (BSc level, course principals: Dr. Žiga Zaplotnik, Prof. Dr. Miha Ravnik)
...
* **Invited lecturer**, University of Ljubljana, virtual (2022)<br/>
  * <ins>Lecture</ins>: **Radiative Transfer Modeling in a Cloudy Atmosphere** (audience: BSc and MSc students of Meteorology and Physics, host: Dr. Žiga Zaplotnik)
    * <ins>Content</ins>: The lecture covers basic principles of radiative transfer theory (absorption, scattering, emission), radiative heating rates in clear-sky versus cloudy atmosphere, three-dimensional Monte Carlo radiation modeling and Independent Column Approximation, two-stream methodology, traditional (plane-parallel) and state-of-the-art representation of subgrid cloud structure in radiation schemes of weather and climate models (e.g., Tripleclouds).
    ...
    ![CloudRepresentation](/images/Crnivec_and_Mayer_2021_Fig1.png) 

    <em><font color="Grey">Various representations of clouds / convection in atmospheric numerical models importantly affect the calculation of radiative transfer (figure courtesy of Črnivec and Mayer, 2021; thunderstorm photo credit: Marko Korošec Weather Photography).</font></em><br/>

* **Teaching assistant**, Ludwig-Maximilians-University Munich, Germany (2016 — 2018)<br/>
  * <ins>Subject</ins>: **Clouds: Microphysics and Convection** (Meteorology MSc course, lecturers: Prof. Dr. Markus Rapp, Dr. Tobias Zinner)  
