...
Set of lectures within interdisciplinary subject **Fundamentals of Environmental Science**:
  ...
  * <ins>Lecture</ins>: **Fundamentals of Meteorology II**
    * <ins>Content</ins>: Mesoscale moist convection (shallow, deep), ordinary thunderstorms versus supercells / mesocyclones, hail, thunderstorm electrification, thunderstorm outbursts and gust front evolution, tornadoes, waterspouts, synoptic mid-latitude weather systems (cyclones, anticyclones) and winds (geostrophic and gradient wind balance, realistic near-surface flow), weather fronts and typical cloud development along warm and cold fronts, general (planetary) circulation, numerical weather prediction (governing equations, physical schemes, initial condition ensemble, forecast uncertainty sources), high-resolution atmospheric modeling.
