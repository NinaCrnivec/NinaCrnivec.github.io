...
The molecular structure of water in its vapor, liquid, and ice phases is examined, along with common defects in natural ice. Atmospheric aerosols are addressed in terms of their classification, sources and sinks, spatial variability, as well as their role as cloud condensation nuclei (CCN) and ice nuclei (IN).
Thermodynamic foundations include the Clausius–Clapeyron equation, supersaturation, supercooled water, and differences in saturation vapor pressure over liquid water and ice. The curvature (Kelvin) and solute (Raoult) effects on saturation vapor pressure are explained, and hence the generalized Köhler framework is established. 
Hydrometeor formation and growth processes are treated in detail, including cloud droplet nucleation, condensational growth, sedimentation and terminal fall velocity, growth by collision and coalescence. Ice-phase processes encompass ice nucleation (involving various types of heterogeneous ice nucleation), depositional growth, aggregation, riming and accretion, hail growth in both dry and wet regimes, and the Wegener–Bergeron–Findeisen mechanism.
The course concludes with an overview of how cloud microphysics is represented in numerical models, including bulk, bin, and Lagrangian schemes, with discussion of their assumptions, advantages, and limitations.
